...
file_path = "C:\\Users\\Admin\\.gemini\\antigravity\\scratch\\distributor-app\\app.js"
...
for line in lines:
    ...
    if "$('sidebar-brand').textContent = co.name || 'DistroManager';" in line:
        new_lines.append("""
...
print("Injection via Python complete.")
